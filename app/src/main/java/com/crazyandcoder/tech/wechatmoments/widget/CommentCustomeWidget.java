...
import com.crazyandcoder.tech.wechatmoments.recycler.SimpleWeakObjectPool;
import com.crazyandcoder.tech.wechatmoments.utils.TimerUtils;
import com.crazyandcoder.tech.wechatmoments.utils.Utils;

import java.util.List;

/**
 * @ClassName: CommentCustomeWidget
 * @Description: java类作用描述
 * @Author: crazyandcoder
 * @email: lijiwork@sina.com
 * @CreateDate: 2020/3/13 10:23 AM
 * @UpdateUser: 更新者
 * @UpdateDate: 2020/3/13 10:23 AM
 * @UpdateRemark: 更新说明
 * @Version: 1.0
 */
public class CommentCustomeWidget extends LinearLayout implements ViewGroup.OnHierarchyChangeListener, OnItemClickPopupMenuListener {
    ...
    public CommentCustomeWidget(Context context) {
        super(context);
        init();
    }

    public CommentCustomeWidget(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public CommentCustomeWidget(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private void addOnItemClickPopupMenuListener(View view, int index, TranslationState translationState) {
        view.setOnLongClickListener(v -> {
            Utils.showPopupMenu(getContext(), CommentCustomeWidget.this, index, v, translationState);
            return false;
        });
    }
